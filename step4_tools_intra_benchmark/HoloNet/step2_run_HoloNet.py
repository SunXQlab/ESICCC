...
adata = sc.read_csv("./input/CID4465_raw_count.csv").T
meta = pd.read_csv("./input/CID4465_meta.csv",  index_col="Barcodes")
adata.obs = meta
adata = sc.read_visium(adata, path = "input")
...
for gene in goi:
    ...
    for lr in list(expressed_LR_df['LR_Pair']):
        ...
        file_path = "./output/" + lr + "_" + gene + ".csv"
